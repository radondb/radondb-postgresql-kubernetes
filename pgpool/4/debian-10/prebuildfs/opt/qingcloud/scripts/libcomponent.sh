#!/bin/bash
#
# Library for managing Qingcloud components

# Constants
CACHE_ROOT="/tmp/qingcloud/pkg/cache"
DOWNLOAD_URL="https://downloads.qingcloud.com/files/stacksmith"

# Functions

########################
# Download and unpack a Qingcloud package
# Globals:
#   OS_NAME
#   OS_ARCH
#   OS_FLAVOUR
